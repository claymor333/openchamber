...
export const MobileHeader: React.FC<{
  ...
  const displayedBranch = currentBranch ?? (showBranchLine ? currentBranchLabel : null);
            ...
            <div ref={swipe.surfaceRef} className="oc-mobile-header-swipe-surface min-w-0">
              ...
              >
                <span ref={swipeMaskLabelRef} className="oc-mobile-header-swipe-label flex min-w-0 flex-col items-start">
                  ...
                  {displayedBranch ? (
                    <span className="flex max-w-full min-w-0 items-center gap-1 truncate typography-micro leading-3 text-muted-foreground">
                      <Icon name="git-branch" className="h-3 w-3 flex-shrink-0 text-muted-foreground/70" />
                      <span className="truncate">{displayedBranch}</span>
                    </span>
                  ) : null}
                </span>
              </button>
