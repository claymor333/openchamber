...
'settings.remoteInstances.clientAuth.actions.addDevice': '기기 추가',
  ...
  'settings.openchamber.mobileSessionSwipe.title': '모바일 세션 스와이프',
  'settings.openchamber.mobileSessionSwipe.info': '각 범위에서 유지할 가까운 세션 수를 선택합니다. 한도는 1~5입니다.',
  'settings.openchamber.mobileSessionSwipe.field.limit': '스와이프 범위당 세션 수',
  'settings.openchamber.mobileSessionSwipe.field.limitHint': '각 프로젝트, 작업 트리 또는 폴더 범위에서 1~5개의 세션을 사용할 수 있습니다.',
  'settings.openchamber.mobileSessionSwipe.field.limitAria': '스와이프 범위당 세션 수',
  'settings.openchamber.mobileSessionSwipe.field.bottomNavigation': '하단 내비게이션 사용',
  'settings.openchamber.mobileSessionSwipe.field.bottomNavigationHint': '모바일에서 세션 헤더를 컴포저 아래에 표시합니다.',
  'settings.openchamber.mobileSessionSwipe.field.bottomNavigationAria': '하단 내비게이션 사용',
  'settings.openchamber.mobileSessionSwipe.actions.resetAria': '모바일 세션 스와이프 한도 초기화',
  ...
  'settings.openchamber.visual.field.hybridTabletUI': '하이브리드 태블릿 레이아웃',
  'settings.openchamber.visual.field.hybridTabletUIAria': '하이브리드 태블릿 레이아웃',
  'settings.openchamber.visual.field.hybridTabletUITooltip': '태블릿에서 데스크톱 스타일 작업 영역 패널과 채팅 레일을 사용합니다.',
