...
'settings.page.tablet.title': '태블릿',
...
'settings.openchamber.visual.section.tablet': '태블릿',
'settings.openchamber.visual.section.tabletHint': '이 기기에서 사용할 인터페이스를 선택합니다. 자동은 화면 크기를 따릉니다. 모바일 또는 데스크탑 UI를 강제할 수 있습니다.',
'settings.openchamber.visual.field.tabletUiMode.auto': '자동',
'settings.openchamber.visual.field.tabletUiMode.autoDesc': '큰 화면에서는 데스크탑 UI, 작은 화면에서는 모바일 UI.',
'settings.openchamber.visual.field.tabletUiMode.mobile': '모바일 UI',
'settings.openchamber.visual.field.tabletUiMode.mobileDesc': '항상 스마트폰 스타일 인터페이스를 사용합니다.',
'settings.openchamber.visual.field.tabletUiMode.desktop': '데스크탑 UI',
'settings.openchamber.visual.field.tabletUiMode.desktopDesc': '항상 전체 데스크탑 인터페이스를 사용합니다.',
  ...
  'settings.openchamber.visual.field.enterToSendAria': 'Enter藤 보내기',
  'settings.openchamber.visual.field.enterToSend': 'Enter藤 보내기',
  'settings.openchamber.visual.field.enterToSendHint': '활성화하면 Enter로 메시지를 보내고 Shift+Enter로 줄을 바끉니다. 비활성화하면 Enter로 줄을 바꾸고 Shift+Enter로 보냑니다.',
