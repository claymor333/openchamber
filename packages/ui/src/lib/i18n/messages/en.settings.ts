...
export const settingsDict = {
  ...
  'settings.openchamber.mobileSessionSwipe.title': 'Mobile session swipe',
  'settings.openchamber.mobileSessionSwipe.info': 'Choose how many nearby sessions each scope keeps available. The limit is 1 to 5.',
  'settings.openchamber.mobileSessionSwipe.field.limit': 'Sessions per swipe scope',
  'settings.openchamber.mobileSessionSwipe.field.limitHint': 'Keep between 1 and 5 sessions available in each project, worktree, or folder scope.',
  'settings.openchamber.mobileSessionSwipe.field.limitAria': 'Sessions per swipe scope',
  'settings.openchamber.mobileSessionSwipe.field.bottomNavigation': 'Use bottom navigation',
  'settings.openchamber.mobileSessionSwipe.field.bottomNavigationHint': 'Keep the session header below the composer on mobile.',
  'settings.openchamber.mobileSessionSwipe.field.bottomNavigationAria': 'Use bottom navigation',
  'settings.openchamber.mobileSessionSwipe.actions.resetAria': 'Reset mobile session swipe limit',
  ...
  'settings.openchamber.visual.field.hybridTabletUITooltip': 'Use desktop-style workspace panel and chat rail on tablets.',
