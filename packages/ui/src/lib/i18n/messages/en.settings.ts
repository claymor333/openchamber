...
'settings.openchamber.visual.section.tabletHint': 'Choose which interface this device uses. Auto follows the screen size; you can force the mobile or desktop UI.',
'settings.openchamber.visual.field.tabletUiMode.auto': 'Auto',
'settings.openchamber.visual.field.tabletUiMode.autoDesc': 'Desktop UI on large screens, mobile UI on small ones.',
'settings.openchamber.visual.field.tabletUiMode.mobile': 'Mobile UI',
'settings.openchamber.visual.field.tabletUiMode.mobileDesc': 'Always use the phone-style interface.',
'settings.openchamber.visual.field.tabletUiMode.desktop': 'Desktop UI',
'settings.openchamber.visual.field.tabletUiMode.desktopDesc': 'Always use the full desktop interface.',
  ...
  'settings.openchamber.visual.field.enterToSendAria': 'Enter to send',
  'settings.openchamber.visual.field.enterToSend': 'Enter to Send',
  'settings.openchamber.visual.field.enterToSendHint': 'When enabled, Enter sends your message and Shift+Enter inserts a new line. When disabled, Enter inserts a new line and Shift+Enter sends.',
