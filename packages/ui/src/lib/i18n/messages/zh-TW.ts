...
export const dict: Record<I18nKey, string> = {
  ...
  'mobile.header.swipe.dragRegionAria': '滑動以切換工作階段',
  'mobile.header.swipe.boundary': '沒有相鄰工作階段',
  'mobile.header.swipe.loading': '工作階段清單仍在載入',
  'mobile.header.swipe.releaseToSwitch': '放開以切換工作階段',
  ...
  'chat.chatInput.actions.sendingAria': '正在傳送訊息',
