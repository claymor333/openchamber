...
"settings.remoteInstances.clientAuth.actions.addDevice": "Añadir un dispositivo",
  ...
  "settings.openchamber.mobileSessionSwipe.title": "Deslizamiento móvil entre sesiones",
  "settings.openchamber.mobileSessionSwipe.info": "Elige cuántas sesiones cercanas mantiene disponible cada ámbito. El límite es de 1 a 5.",
  "settings.openchamber.mobileSessionSwipe.field.limit": "Sesiones por ámbito de deslizamiento",
  "settings.openchamber.mobileSessionSwipe.field.limitHint": "Mantén disponibles entre 1 y 5 sesiones en cada ámbito de proyecto, árbol de trabajo o carpeta.",
  "settings.openchamber.mobileSessionSwipe.field.limitAria": "Sesiones por ámbito de deslizamiento",
  "settings.openchamber.mobileSessionSwipe.field.bottomNavigation": "Usar navegación inferior",
  "settings.openchamber.mobileSessionSwipe.field.bottomNavigationHint": "Mantén el encabezado de sesión debajo del compositor en el móvil.",
  "settings.openchamber.mobileSessionSwipe.field.bottomNavigationAria": "Usar navegación inferior",
  "settings.openchamber.mobileSessionSwipe.actions.resetAria": "Restablecer el límite de deslizamiento móvil entre sesiones",
  ...
  "settings.openchamber.visual.field.hybridTabletUI": "Diseño híbrido de tablet",
  "settings.openchamber.visual.field.hybridTabletUIAria": "Diseño híbrido de tablet",
  "settings.openchamber.visual.field.hybridTabletUITooltip": "Usar el panel de espacio de trabajo y la barra de chat de escritorio en tablets.",
