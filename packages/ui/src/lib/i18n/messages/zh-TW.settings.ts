...
'settings.openchamber.visual.section.tabletHint': '選擇此裝置使用的介面。自動會依螢幕尺寸決定；你也可以強制使用行動版或桌面版介面。',
'settings.openchamber.visual.field.tabletUiMode.auto': '自動',
'settings.openchamber.visual.field.tabletUiMode.autoDesc': '大螢幕使用桌面版介面，小螢幕使用行動版介面。',
'settings.openchamber.visual.field.tabletUiMode.mobile': '行動版介面',
'settings.openchamber.visual.field.tabletUiMode.mobileDesc': '一律使用手機風格介面。',
'settings.openchamber.visual.field.tabletUiMode.desktop': '桌面版介面',
'settings.openchamber.visual.field.tabletUiMode.desktopDesc': '一律使用完整的桌面版介面。',
  ...
  'settings.openchamber.visual.field.enterToSendAria': 'Enter 傳送',
  'settings.openchamber.visual.field.enterToSend': 'Enter 傳送',
  'settings.openchamber.visual.field.enterToSendHint': '啟用後，按 Enter 傳送訊息，按 Shift+Enter 換行。停用後，按 Enter 換行，按 Shift+Enter 傳送。',
