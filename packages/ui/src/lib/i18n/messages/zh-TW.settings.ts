...
'settings.remoteInstances.clientAuth.actions.addDevice': '新增裝置',
  ...
  'settings.openchamber.mobileSessionSwipe.title': '行動裝置工作階段滑動',
  'settings.openchamber.mobileSessionSwipe.info': '選擇每個範圍保留多少個相鄰工作階段。上限為 1 到 5 個。',
  'settings.openchamber.mobileSessionSwipe.field.limit': '每個滑動範圍的工作階段數',
  'settings.openchamber.mobileSessionSwipe.field.limitHint': '在每個專案、工作樹或資料夾範圍內保留 1 到 5 個可用工作階段。',
  'settings.openchamber.mobileSessionSwipe.field.limitAria': '每個滑動範圍的工作階段數',
  'settings.openchamber.mobileSessionSwipe.field.bottomNavigation': '使用底部導覽',
  'settings.openchamber.mobileSessionSwipe.field.bottomNavigationHint': '在行動裝置上將工作階段標題列放在編輯器下方。',
  'settings.openchamber.mobileSessionSwipe.field.bottomNavigationAria': '使用底部導覽',
  'settings.openchamber.mobileSessionSwipe.actions.resetAria': '重設行動裝置工作階段滑動上限',
  ...
  'settings.openchamber.visual.field.hybridTabletUI': '混合平板電腦佈局',
  'settings.openchamber.visual.field.hybridTabletUIAria': '混合平板電腦佈局',
  'settings.openchamber.visual.field.hybridTabletUITooltip': '在平板電腦上使用桌面風格的工作區面板和聊天軌道。',
