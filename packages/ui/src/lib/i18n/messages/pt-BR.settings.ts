...
"settings.remoteInstances.clientAuth.actions.addDevice": "Adicionar um dispositivo",
  ...
  "settings.openchamber.mobileSessionSwipe.title": "Deslize entre sessões no celular",
  "settings.openchamber.mobileSessionSwipe.info": "Escolha quantas sessões próximas ficam disponíveis em cada escopo. O limite é de 1 a 5.",
  "settings.openchamber.mobileSessionSwipe.field.limit": "Sessões por escopo de deslize",
  "settings.openchamber.mobileSessionSwipe.field.limitHint": "Mantenha de 1 a 5 sessões disponíveis em cada escopo de projeto, worktree ou pasta.",
  "settings.openchamber.mobileSessionSwipe.field.limitAria": "Sessões por escopo de deslize",
  "settings.openchamber.mobileSessionSwipe.field.bottomNavigation": "Usar navegação inferior",
  "settings.openchamber.mobileSessionSwipe.field.bottomNavigationHint": "Mantenha o cabeçalho da sessão abaixo do compositor no celular.",
  "settings.openchamber.mobileSessionSwipe.field.bottomNavigationAria": "Usar navegação inferior",
  "settings.openchamber.mobileSessionSwipe.actions.resetAria": "Redefinir o limite de deslize entre sessões",
  ...
  "settings.openchamber.visual.field.hybridTabletUI": "Layout híbrido de tablet",
  "settings.openchamber.visual.field.hybridTabletUIAria": "Layout híbrido de tablet",
  "settings.openchamber.visual.field.hybridTabletUITooltip": "Usar painel de espaço de trabalho e trilho de chat de desktop em tablets.",
