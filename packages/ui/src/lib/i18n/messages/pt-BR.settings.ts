...
"settings.openchamber.visual.section.tabletHint": "Escolha qual interface este dispositivo usa. Automático segue o tamanho da tela; você pode forçar a interface móvel ou de desktop.",
"settings.openchamber.visual.field.tabletUiMode.auto": "Automático",
"settings.openchamber.visual.field.tabletUiMode.autoDesc": "Interface de desktop em telas grandes, móvel em telas pequenas.",
"settings.openchamber.visual.field.tabletUiMode.mobile": "Interface móvel",
"settings.openchamber.visual.field.tabletUiMode.mobileDesc": "Sempre usar a interface estilo celular.",
"settings.openchamber.visual.field.tabletUiMode.desktop": "Interface de desktop",
"settings.openchamber.visual.field.tabletUiMode.desktopDesc": "Sempre usar a interface de desktop completa.",
  ...
  "settings.openchamber.visual.field.enterToSendHint": "Quando ativado, Enter envia sua mensagem e Shift+Enter insere uma nova linha. Quando desativado, Enter insere uma nova linha e Shift+Enter envia.",
