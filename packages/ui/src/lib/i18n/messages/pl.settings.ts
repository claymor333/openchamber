export const settingsDict = {
  ...
  'settings.openchamber.visual.field.enterToSendAria': 'Enter, aby wysłać',
  'settings.openchamber.visual.field.enterToSend': 'Enter, aby wysłać',
  'settings.openchamber.visual.field.enterToSendHint': 'Gdy włączone, Enter wysyła wiadomość, a Shift+Enter wstawia nową linię. Gdy wyłączone, Enter wstawia nową linię, a Shift+Enter wysyła.',
...
'settings.openchamber.visual.section.tabletHint': 'Wybierz interfejs używany na tym urządzeniu. Auto dopasowuje się do rozmiaru ekranu; możesz wymusić interfejs mobilny lub desktopowy.',
'settings.openchamber.visual.field.tabletUiMode.auto': 'Automatycznie',
'settings.openchamber.visual.field.tabletUiMode.autoDesc': 'Interfejs desktopowy na dużych ekranach, mobilny na małych.',
'settings.openchamber.visual.field.tabletUiMode.mobile': 'Interfejs mobilny',
'settings.openchamber.visual.field.tabletUiMode.mobileDesc': 'Zawsze używaj interfejsu w stylu telefonu.',
'settings.openchamber.visual.field.tabletUiMode.desktop': 'Interfejs desktopowy',
'settings.openchamber.visual.field.tabletUiMode.desktopDesc': 'Zawsze używaj pełnego interfejsu desktopowego.',
