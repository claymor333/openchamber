...
export const settingsDict = {
  ...
  'settings.openchamber.mobileSessionSwipe.title': 'Mobilne przesuwanie między sesjami',
  'settings.openchamber.mobileSessionSwipe.info': 'Wybierz liczbę pobliskich sesji dostępnych w każdym zakresie. Limit wynosi od 1 do 5.',
  'settings.openchamber.mobileSessionSwipe.field.limit': 'Sesje na zakres przesuwania',
  'settings.openchamber.mobileSessionSwipe.field.limitHint': 'W każdym zakresie projektu, worktree lub folderu udostępniaj od 1 do 5 sesji.',
  'settings.openchamber.mobileSessionSwipe.field.limitAria': 'Sesje na zakres przesuwania',
  'settings.openchamber.mobileSessionSwipe.field.bottomNavigation': 'Używaj dolnej nawigacji',
  'settings.openchamber.mobileSessionSwipe.field.bottomNavigationHint': 'Na urządzeniach mobilnych umieszczaj nagłówek sesji pod kompozytorem.',
  'settings.openchamber.mobileSessionSwipe.field.bottomNavigationAria': 'Używaj dolnej nawigacji',
  'settings.openchamber.mobileSessionSwipe.actions.resetAria': 'Zresetuj limit mobilnego przesuwania sesji',
  ...
  'settings.openchamber.visual.field.hybridTabletUI': 'Hybrydowy układ tabletu',
  'settings.openchamber.visual.field.hybridTabletUIAria': 'Hybrydowy układ tabletu',
  'settings.openchamber.visual.field.hybridTabletUITooltip': 'Używaj panelu obszaru roboczego i szyny czatu w stylu desktop na tabletach.',
