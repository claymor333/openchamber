...
export const dict: Record<I18nKey, string> = {
  ...
  'mobile.header.swipe.dragRegionAria': 'Przesuń, aby zmienić sesję',
  'mobile.header.swipe.boundary': 'Brak sąsiedniej sesji',
  'mobile.header.swipe.loading': 'Lista sesji jest nadal ładowana',
  'mobile.header.swipe.releaseToSwitch': 'Puść, aby zmienić sesję',
