...
'settings.remoteInstances.clientAuth.actions.addDevice': '添加设备',
  ...
  'settings.openchamber.mobileSessionSwipe.title': '移动端会话滑动',
  'settings.openchamber.mobileSessionSwipe.info': '选择每个范围保留多少个相邻会话。上限为 1 到 5 个。',
  'settings.openchamber.mobileSessionSwipe.field.limit': '每个滑动范围的会话数',
  'settings.openchamber.mobileSessionSwipe.field.limitHint': '在每个项目、工作树或文件夹范围内保留 1 到 5 个可用会话。',
  'settings.openchamber.mobileSessionSwipe.field.limitAria': '每个滑动范围的会话数',
  'settings.openchamber.mobileSessionSwipe.field.bottomNavigation': '使用底部导航',
  'settings.openchamber.mobileSessionSwipe.field.bottomNavigationHint': '在移动设备上将会话标题栏放在编辑器下方。',
  'settings.openchamber.mobileSessionSwipe.field.bottomNavigationAria': '使用底部导航',
  'settings.openchamber.mobileSessionSwipe.actions.resetAria': '重置移动端会话滑动上限',
  ...
  'settings.openchamber.visual.field.hybridTabletUI': '混合平板布局',
  'settings.openchamber.visual.field.hybridTabletUIAria': '混合平板布局',
  'settings.openchamber.visual.field.hybridTabletUITooltip': '在平板电脑上使用桌面风格的工作区面板和聊天轨道。',
