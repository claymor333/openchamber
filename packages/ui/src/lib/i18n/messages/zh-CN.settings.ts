...
'settings.openchamber.visual.section.tablet': '平板',
'settings.openchamber.visual.section.tabletHint': '选择此设备使用的界面。自动跟随屏幕尺寸；你也可以强制使用移动端或桌面端界面。',
'settings.openchamber.visual.field.tabletUiMode.auto': '自动',
'settings.openchamber.visual.field.tabletUiMode.autoDesc': '大屏幕用桌面端界面，小屏幕用移动端界面。',
'settings.openchamber.visual.field.tabletUiMode.mobile': '移动端界面',
'settings.openchamber.visual.field.tabletUiMode.mobileDesc': '始终使用手机风格界面。',
'settings.openchamber.visual.field.tabletUiMode.desktop': '桌面端界面',
'settings.openchamber.visual.field.tabletUiMode.desktopDesc': '始终使用完整的桌面端界面。',
  ...
  'settings.openchamber.visual.field.enterToSendAria': '回车发送',
  'settings.openchamber.visual.field.enterToSend': '回车发送',
  'settings.openchamber.visual.field.enterToSendHint': '启用后，按 Enter 发送消息，按 Shift+Enter 换行。禁用后，按 Enter 换行，按 Shift+Enter 发送。',
