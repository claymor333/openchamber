...
export const dict: Record<I18nKey, string> = {
  ...
  "mobile.header.swipe.dragRegionAria": "Desliza para cambiar de sesión",
  "mobile.header.swipe.boundary": "No hay una sesión adyacente",
  "mobile.header.swipe.loading": "La lista de sesiones aún se está cargando",
  "mobile.header.swipe.releaseToSwitch": "Suelta para cambiar de sesión",
