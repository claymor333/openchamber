...
export const dict: Record<I18nKey, string> = {
  ...
  "mobile.header.swipe.dragRegionAria": "Проведіть, щоб змінити сесію",
  "mobile.header.swipe.boundary": "Сусідньої сесії немає",
  "mobile.header.swipe.loading": "Список сесій ще завантажується",
  "mobile.header.swipe.releaseToSwitch": "Відпустіть, щоб змінити сесію",
