...
'settings.remoteInstances.clientAuth.actions.addDevice': 'デバイスを追加',
  ...
  'settings.openchamber.mobileSessionSwipe.title': 'モバイルセッションスワイプ',
  'settings.openchamber.mobileSessionSwipe.info': '各スコープで保持する近接セッション数を選択します。範囲は 1〜5 です。',
  'settings.openchamber.mobileSessionSwipe.field.limit': 'スワイプスコープごとのセッション数',
  'settings.openchamber.mobileSessionSwipe.field.limitHint': '各プロジェクト、ワークツリー、フォルダーのスコープで 1〜5 件のセッションを利用できます。',
  'settings.openchamber.mobileSessionSwipe.field.limitAria': 'スワイプスコープごとのセッション数',
  'settings.openchamber.mobileSessionSwipe.field.bottomNavigation': '下部ナビゲーションを使用',
  'settings.openchamber.mobileSessionSwipe.field.bottomNavigationHint': 'モバイルではセッションヘッダーをコンポーザーの下に表示します。',
  'settings.openchamber.mobileSessionSwipe.field.bottomNavigationAria': '下部ナビゲーションを使用',
  'settings.openchamber.mobileSessionSwipe.actions.resetAria': 'モバイルセッションスワイプの上限をリセット',
  ...
  'settings.openchamber.visual.field.hybridTabletUI': 'ハイブリッドタブレットレイアウト',
  'settings.openchamber.visual.field.hybridTabletUIAria': 'ハイブリッドタブレットレイアウト',
  'settings.openchamber.visual.field.hybridTabletUITooltip': 'タブレットでデスクトップスタイルのワークスペースパネルとチャットレールを使用します。',
