...
export const dict: Record<I18nKey, string> = {
  ...
  'mobile.header.swipe.dragRegionAria': '滑动以切换会话',
  'mobile.header.swipe.boundary': '没有相邻会话',
  'mobile.header.swipe.loading': '会话列表仍在加载',
  'mobile.header.swipe.releaseToSwitch': '松开以切换会话',
