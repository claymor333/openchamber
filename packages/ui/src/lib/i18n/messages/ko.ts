...
export const dict: Record<I18nKey, string> = {
  ...
  'mobile.header.swipe.dragRegionAria': '스와이프하여 세션 변경',
  'mobile.header.swipe.boundary': '인접한 세션 없음',
  'mobile.header.swipe.loading': '세션 목록을 아직 불러오는 중',
  'mobile.header.swipe.releaseToSwitch': '놓아서 세션 변경',
