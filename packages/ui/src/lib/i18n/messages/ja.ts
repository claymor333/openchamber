...
export const dict: Record<I18nKey, string> = {
  ...
  'mobile.header.swipe.dragRegionAria': 'スワイプしてセッションを変更',
  'mobile.header.swipe.boundary': '隣接するセッションはありません',
  'mobile.header.swipe.loading': 'セッション一覧を読み込み中',
  'mobile.header.swipe.releaseToSwitch': '離してセッションを変更',
  ...
  'chat.chatInput.actions.sendingAria': 'メッセージを送信中',
