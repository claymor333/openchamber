...
export const dict = {
  ...
  'mobile.header.swipe.dragRegionAria': 'Swipe to change session',
  'mobile.header.swipe.boundary': 'No adjacent session',
  'mobile.header.swipe.loading': 'Session list is still loading',
  'mobile.header.swipe.releaseToSwitch': 'Release to switch session',
