...
export const dict = {
  ...
  'mobile.header.swipe.dragRegionAria': 'Balayez pour changer de session',
  'mobile.header.swipe.boundary': 'Aucune session voisine',
  'mobile.header.swipe.loading': 'La liste des sessions se charge encore',
  'mobile.header.swipe.releaseToSwitch': 'Relâchez pour changer de session',
