...
export const settingsDict = {
  ...
  'settings.openchamber.mobileSessionSwipe.title': 'Balayage mobile entre les sessions',
  'settings.openchamber.mobileSessionSwipe.info': 'Choisissez le nombre de sessions proches conservées dans chaque périmètre. La limite va de 1 à 5.',
  'settings.openchamber.mobileSessionSwipe.field.limit': 'Sessions par périmètre de balayage',
  'settings.openchamber.mobileSessionSwipe.field.limitHint': 'Conservez de 1 à 5 sessions disponibles dans chaque périmètre de projet, d’arbre de travail ou de dossier.',
  'settings.openchamber.mobileSessionSwipe.field.limitAria': 'Sessions par périmètre de balayage',
  'settings.openchamber.mobileSessionSwipe.field.bottomNavigation': 'Utiliser la navigation inférieure',
  'settings.openchamber.mobileSessionSwipe.field.bottomNavigationHint': 'Gardez l’en-tête de session sous le compositeur sur mobile.',
  'settings.openchamber.mobileSessionSwipe.field.bottomNavigationAria': 'Utiliser la navigation inférieure',
  'settings.openchamber.mobileSessionSwipe.actions.resetAria': 'Réinitialiser la limite de balayage mobile entre les sessions',
  ...
  'settings.openchamber.visual.field.hybridTabletUI': 'Disposition hybride tablette',
  'settings.openchamber.visual.field.hybridTabletUIAria': 'Disposition hybride tablette',
  'settings.openchamber.visual.field.hybridTabletUITooltip': 'Utiliser le panneau d\'espace de travail et le rail de chat de bureau sur tablettes.',
